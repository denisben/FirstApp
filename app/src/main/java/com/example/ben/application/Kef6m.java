...
public class Kef6m extends AppCompatActivity {

    Button b1, b2, b3, b4;
    TextView questions, scores;
    private QuestionLibrary6 mQuestionLibrary6 = new QuestionLibrary6();
    private QuestionBook6 mQuestionBook6= new QuestionBook6();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kef6m);

        Bundle bundle = getIntent().getExtras();
        int slScore = bundle.getInt("finalScore");
        mScore = (slScore + mScore);

        fscore = mQuestionLibrary6.getLength() + mQuestionBook6.getLength();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b1.getText() == mAnswer) {
                    mScore = mScore + 1;
                    updateScore(mScore);
                    Toast.makeText(Kef6m.this, "Correct", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }else {
    ...
    private  void updateQuestion() {
        if (mQuestionNumber < mQuestionLibrary6.getLength()) {
            questions.setText(mQuestionLibrary6.getQuestions(mQuestionNumber));
            sImageView.setImageResource(QuestionLibrary6.images[mQuestionNumber]);
            b1.setText(mQuestionLibrary6.getChoice1(mQuestionNumber));
            b2.setText(mQuestionLibrary6.getChoice2(mQuestionNumber));
            b3.setText(mQuestionLibrary6.getChoice3(mQuestionNumber));
            b4.setText(mQuestionLibrary6.getChoice4(mQuestionNumber));
            mAnswer = mQuestionLibrary6.getCorrectAnswer(mQuestionNumber);
            mQuestionNumber++;
        } else {

            Intent i = new Intent(Kef6m.this, ResultsActivity.class);
    ...
    private void cAnswer(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Kef6m.this);
        alertDialogBuilder
    ...
    private void askToClose (){
        AlertDialog.Builder builder = new AlertDialog.Builder(Kef6m.this);
