...
public class Kef5m extends AppCompatActivity {

    Button b1, b2, b3, b4;
    TextView questions, scores;
    private QuestionLibrary5 mQuestionLibrary5 = new QuestionLibrary5();
    private QuestionBook5 mQuestionBook5 = new QuestionBook5();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kef5m);

        Bundle bundle = getIntent().getExtras();
        int slScore = bundle.getInt("finalScore");
        mScore = (slScore + mScore);

        fscore = mQuestionLibrary5.getLength() + mQuestionBook5.getLength();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b1.getText() == mAnswer) {
                    mScore = mScore + 1;
                    updateScore(mScore);
                    Toast.makeText(Kef5m.this, "Correct", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }else {
    ...
    private  void updateQuestion() {
        if (mQuestionNumber < mQuestionLibrary5.getLength()) {
            questions.setText(mQuestionLibrary5.getQuestions(mQuestionNumber));
            sImageView.setImageResource(QuestionLibrary.images[mQuestionNumber]);
            b1.setText(mQuestionLibrary5.getChoice1(mQuestionNumber));
            b2.setText(mQuestionLibrary5.getChoice2(mQuestionNumber));
            b3.setText(mQuestionLibrary5.getChoice3(mQuestionNumber));
            b4.setText(mQuestionLibrary5.getChoice4(mQuestionNumber));
            mAnswer = mQuestionLibrary5.getCorrectAnswer(mQuestionNumber);
            mQuestionNumber++;
        } else {

            Intent i = new Intent(Kef5m.this, ResultsActivity.class);
    ...
    private void cAnswer(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Kef5m.this);
        alertDialogBuilder
    ...
    private void askToClose (){
        AlertDialog.Builder builder = new AlertDialog.Builder(Kef5m.this);
